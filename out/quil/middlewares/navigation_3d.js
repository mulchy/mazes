...
var vec__6517 = axis;
var a_x = cljs.core.nth.call(null,vec__6517,(0),null);
var a_y = cljs.core.nth.call(null,vec__6517,(1),null);
var a_z = cljs.core.nth.call(null,vec__6517,(2),null);
var vec__6518 = v;
var x = cljs.core.nth.call(null,vec__6518,(0),null);
var y = cljs.core.nth.call(null,vec__6518,(1),null);
var z = cljs.core.nth.call(null,vec__6518,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__6519,p__6520){
var vec__6523 = p__6519;
var u1 = cljs.core.nth.call(null,vec__6523,(0),null);
var u2 = cljs.core.nth.call(null,vec__6523,(1),null);
var u3 = cljs.core.nth.call(null,vec__6523,(2),null);
var vec__6524 = p__6520;
var v1 = cljs.core.nth.call(null,vec__6524,(0),null);
var v2 = cljs.core.nth.call(null,vec__6524,(1),null);
var v3 = cljs.core.nth.call(null,vec__6524,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__6525_SHARP_){
return (p1__6525_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__6526_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__6527_SHARP_,angle_lr),angle_ud);
...
var map__6534 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__6534__$1 = ((((!((map__6534 == null)))?((((map__6534.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6534.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6534):map__6534);
var up = cljs.core.get.call(null,map__6534__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__6534__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__6536 = cljs.core._EQ_;
var expr__6537 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__6536.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__6537))){
return straight;
} else {
if(cljs.core.truth_(pred__6536.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__6537))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__6536.call(null,quil.middlewares.navigation_3d.space,expr__6537))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__6536.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__6537))){
return up;
} else {
if(cljs.core.truth_(pred__6536.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__6537))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__6536.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__6537))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__6534,map__6534__$1,up,straight){
return (function (p1__6528_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__6528_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__6534,map__6534__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__6539_SHARP_);
});})(initial_state))
);
});
/**
...
var map__6545_6550 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__6545_6551__$1 = ((((!((map__6545_6550 == null)))?((((map__6545_6550.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6545_6550.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6545_6550):map__6545_6550);
var vec__6546_6552 = cljs.core.get.call(null,map__6545_6551__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_6553 = cljs.core.nth.call(null,vec__6546_6552,(0),null);
var c_y_6554 = cljs.core.nth.call(null,vec__6546_6552,(1),null);
var c_z_6555 = cljs.core.nth.call(null,vec__6546_6552,(2),null);
var vec__6547_6556 = cljs.core.get.call(null,map__6545_6551__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_6557 = cljs.core.nth.call(null,vec__6547_6556,(0),null);
var u_y_6558 = cljs.core.nth.call(null,vec__6547_6556,(1),null);
var u_z_6559 = cljs.core.nth.call(null,vec__6547_6556,(2),null);
var vec__6548_6560 = cljs.core.get.call(null,map__6545_6551__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_6561 = cljs.core.nth.call(null,vec__6548_6560,(0),null);
var p_y_6562 = cljs.core.nth.call(null,vec__6548_6560,(1),null);
var p_z_6563 = cljs.core.nth.call(null,vec__6548_6560,(2),null);
quil.core.camera.call(null,p_x_6561,p_y_6562,p_z_6563,(p_x_6561 + c_x_6553),(p_y_6562 + c_y_6554),(p_z_6563 + c_z_6555),u_x_6557,u_y_6558,u_z_6559);
